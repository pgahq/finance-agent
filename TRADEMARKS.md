...
Use of this software does not imply, grant, or authorize any license to use PGA of America trademarks in connection with any modified, redistributed, or derivative versions of this software, nor in connection with any services hosted using this software.
...
## 3. Nominative Use Only

You may use the text "PGA of America" solely to provide accurate, factual attribution regarding the origin of the original, unmodified source code (e.g., "This project contains source code originally released by the PGA of America"). Any such use must strictly be nominative and must not suggest sponsorship, endorsement, partnership, or affiliation.

## Contact

For questions regarding brand licensing or trademark enforcement, please contact the PGA of America Legal Department at [legal@pgahq.com](mailto:legal@pgahq.com).
